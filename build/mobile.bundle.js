				...
				React.createElement("div", null, 
					React.createElement("div", null, 
						React.createElement("header", {className: "bar bar-nav"}, 
		      				React.createElement("h1", {className: "title"}, "Ratchet")
		    			)
					), 
					React.createElement("div", {className: "content"}, 
		      			React.createElement("p", {className: "content-padded"}, "Thanks for downloading Ratchet. This is an example HTML page thatd up to compiled Ratchet CSS and JS, has the proper meta tags and the HTML structure. Need some more help before you start filling this with your own content? Check out some Ratchet resources:"), 
		 				React.createElement("div", {className: "card"}, 
		        			React.createElement("ul", {className: "table-view"}, 
					          React.createElement("li", {className: "table-view-cell"}, 
					            React.createElement("a", {className: "push-right", href: "http://goratchet.com"}, 
					              React.createElement("strong", null, "Ratchet documentation")
					            )
					          ), 
					          React.createElement("li", {className: "table-view-cell"}, 
					            React.createElement("a", {className: "push-right", href: "https://github.com/twbs/ratchet/"}, 
					              React.createElement("strong", null, "Ratchet on Github")
					            )
					          )
